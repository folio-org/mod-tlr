...
class DcbServiceTest {
  ...
  @CsvSource(value = {
    ...
    "PICKUP, ITEM_CHECKED_OUT, ITEM_CHECKED_IN, true",
    "PICKUP, ITEM_CHECKED_OUT, CLOSED, true",
    ...
    "BORROWING-PICKUP, ITEM_CHECKED_OUT, ITEM_CHECKED_IN, true",
    "BORROWING-PICKUP, ITEM_CHECKED_OUT, CLOSED, true",
    ...
    "BORROWER, ITEM_CHECKED_OUT, CLOSED, true",
